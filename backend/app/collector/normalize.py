...
def normalize_record(item: Mapping[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "end_time": end_time,
        "activity_type": str(item.get("activityType") or "").strip() or None,
        "target_text": str(item.get("targetText") or "").strip() or None,
        "status": detect_status(recruit_end_date, recruit_count, applied_count),
        "recruit_count": recruit_count,
        "applied_count": applied_count,
        "is_remote": is_remote,
        "description": str(item.get("descriptionText") or "").strip() or None,
